...
const projects = [
  {
    ...
    image: 'https://images.pexels.com/photos/38519/macbook-laptop-ipad-apple-38519.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    live: '#',
    case: '#',
    demo: true,
  },
  {
    ...
    desc: 'Full-featured online store with product management, cart, and payment processing.',
  ...
  },
  {
    ...
    desc: 'Enterprise mobile application with multi-role dashboards and real-time data.',
